...
router.get('/', function(req, res, next) {
    ...
    if(req.session.user && req.session.user.username!="")
    {
        ...
        console.log(req.session.user.userinterest.nba);
        switch(channel)
        {
        ...
        a = [{name: "财经", num: useri.finance}, {name: "体育", num: useri.sports}, {name: "娱乐", num: useri.ent}, {name: "军事", num: useri.mil},
              ...
              d2_list.newsInfo(function(err, result4){
                  ...
                  d3_list.newsInfo(function(err, result5){
                      ...
                      d4_list.newsInfo(function(err, result6){
                          res.render('index', {data: result, adata: result2, d1:result3, d2:result4, d3:result5, d4:result6, order: a});
                      });
                  });
